...
def show_menu():
    """Main loop for the menu — keeps running until player quits."""
    while True:
        clear_screen()
        ...
        try:
            ...
            print("Invalid input. Please enter a number, 'q', or '0'.")
            input("Press Enter...")
        except AttributeError:
            print(f"Error: The selected chapter file '{selected_chapter_name}.py' "
                  f"is missing the 'start_game' function.")
